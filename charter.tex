...
\autor{Freddy Julian Riascos Salas}
...
\begin{enumerate}
	\item Requerimientos funcionales:
		\begin{enumerate}
			\item El sistema debe permitir la adquisición de señales EEG en tiempo real.
			\item El sistema debe realizar el procesamiento de datos para alimentar el modelo.
			\item La infraestructura en la nube debe procesar y devolver predicciones con una latencia menor a 800ms. 
			\item El sistema debe tener una integración para la comunicación y envió de datos EEG a la nube.
		\end{enumerate}
	\item Requerimientos de documentación:
		\begin{enumerate}
			\item Se debe entregar documentación técnica sobre la arquitectura del sistema, modelos utilizados y configuración en la nube.
			\item Se debe incluir una memoria técnica con los resultados del entrenamiento del modelo.
		\end{enumerate}
	\item Requerimiento de testing:
		\begin{enumerate}
			\item El modelo debe ser validado con un conjunto de datos independientes.
			\item La API debe ser sometida a pruebas de carga para garantizar la estabilidad de solicitudes concurrentes.
		\end{enumerate}
	\item Requerimientos de la interfaz:
		\begin{enumerate}
			\item La interfaz debe permitir la interpretación de las señales para mostrar la acción imaginada. (esto no se si es posible pero para añadir una web o algo grafico )
			\item La interfaz debe permitir exportar los datos procesados en formatos CSV y JSON.
		\end{enumerate}
	\item Requerimientos Regulatorios y de Seguridad:
		\begin{enumerate}
			\item Toda la comunicación de datos entre los dispositivos y la nube debe estar cifrada con TLS/SSL.
		\end{enumerate}
\end{enumerate}
