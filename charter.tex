...
\textit{Objetivo}: Desarrollar un modelo de IA que analice señales EEG predecir la intención de movimiento en usuarios, facilitando aplicaciones en neurorehabilitación y control de dispositivos.

\textit{Valor agregado}: Automatización del análisis de señales cerebrales para mejorar la accesibilidad a tecnologías BCI (Brain-Computer Interface).
...
\begin{itemize}
	...
	\item Fuentes: Sensores EEG comerciales (OpenBCI, Emotiv) o bases de datos públicas.
	\item Cantidad: Al menos 100,000 registros diarios procesados en AWS.
...
\begin{itemize}
	...
	\item Características temporales obtenidas con algoritmos de STFT y Wavelet.
\end{itemize}
...
\begin{itemize}
	...
	\item Eliminación de artefactos usando algoritmos ICA o PCA.
\end{itemize}

Modelado

El problema se define como una clasificación de señales EEG para la predicción de imaginación motriz.
Mientras que las arquitecturas candidatas para este problema estan definidas en redes neuronales como CNNs, RNNs y Transformers.
...
El modelo se implementará con un sistema basado en la nube con AWS lambda para procesamiento una API-REST para enviar los datos a la nube y una fuente
