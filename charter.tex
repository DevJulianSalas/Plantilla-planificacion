...
HU1 & Investigación y selección de datasets públicos relevantes & 8 h & Alta \\ \hline
HU1 & Descarga manual y validación de estructura de archivos EEG del primer dataset & 8 h & Alta \\ \hline
...
HU1 & Almacenamiento y organización de señales EEG				 & 8 h & Alta \\ \hline
...
HU3 & Selección de señales EEG preprocesadas para el entrenamiento						 & 8 h & Alta \\ \hline
...
HU3 & Implementación del segundo modelo 	(alternativo)			 & 8 h & Medio \\ \hline
HU3 & Entrenamiento y evaluación de cada modelo con métricas de precisión, recall, F1				 & 6 h & Alta \\ \hline
HU3 & Ajuste de hiperparámetros iniciales 				 & 6 h & Media \\ \hline
HU3 & Validación cruzada con datos independientes	 				 & 6 h & Alta \\ \hline
HU3 & Análisis comparativo entre modelos				 & 6 h & Media \\ \hline
HU4 & Ajuste de hiperparámetros para reducir la latencia del modelo					 & 6 h & Baja \\ \hline
HU4 & Evaluación comparativa del modelo con diferentes configuraciones				 & 8 h & Alta \\ \hline
...
HU5 & Configurar logs, métricas y alertas para el procesamiento de los datasets 					 & 8 h & Alta \\ \hline
HU6 & Definir la arquitectura de despliegue 					 & 8 h & Alta \\ \hline
HU6 & Automatizar el build, pruebas y despliegue de los modelos 					 & 8 h & Alta \\ \hline
HU6 & Implementar un mecanismo para almacenar versiones del modelo y realizar rollbacks	 					 & 8 h & Media \\ \hline
HU6 & Implementar una API REST que sirva el modelo optimizado	 					 & 8 h & Alta \\ \hline
HU7 & Aplicar un sistema de gráficos EGG en una plataforma de visualización	 					 & 8 h & Alta \\ \hline
HU7 & Añadir un control de acceso y protección de los datos 	 					 & 6 h & Media \\ \hline
HU8 & Configurar cifrado en reposo de los servicios que transmiten 					 & 8 h & Alta \\ \hline
HU8 & Aplicar cifrado en tránsito para los datos enviados desde puntos de conexión 	 					 & 6 h & Media \\ \hline
\end{tabularx}
\end{table}
...
\rowcolor[HTML]{C0C0C0}
Historia de usuario & Tarea técnica & Estimación & Prioridad \\ \hline
HU8 & Definir e implementar politicas y reglas de retención de datos  & 6 h & Media \\ \hline
HU8 & Configurar un registro y monitoreo de accesos  	 					 & 8 h & Alta \\ \hline
\end{tabularx}
\end{table}
