...
Métricas de éxito: 
\begin{itemize}
    \item Tiempo total de respuesta en tareas motoras imaginadas.
    \item Precisión en la detección de imaginación motriz.
    \item Tiempo total de análisis manual de señales EEG.
\end{itemize}
