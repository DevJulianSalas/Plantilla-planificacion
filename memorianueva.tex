...
Para su implementación fueron necesarios los conocimientos adquiridos en la especialización incluidos procesamiento y análisis de datos, aprendizaje automatico, redes neuronales y operaciones.
\end{abstract}
