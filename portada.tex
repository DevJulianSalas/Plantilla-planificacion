...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Interfaces Cerebro-Cloud para la predicción de actividades de imaginación motriz} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Freddy Julian Riascos Salas} \\[1cm]
        ...
        \textbf{Director:} Mg. Ing. Jaime Andrés Riascos Salas (Potsdam Embodied Cognition Group)} \\[1cm]
        ...
        Ciudad de Pasto, marzo de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
